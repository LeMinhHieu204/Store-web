    ...
    <div class="layout">
        <aside class="sidebar">
            <div class="brand-card">
                <h2>Admin Console</h2>
                <p><?php echo e($admin->name ?? 'Administrator'); ?></p>
            </div>

            <nav class="sidebar-nav">
                <a class="sidebar-link <?php echo e($currentRoute === 'admin.dashboard' ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
                    <span>Dashboard</span>
                    <small>/admin</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.products.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.products.index')); ?>">
                    <span>Sản phẩm</span>
                    <small>Catalog</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.categories.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.categories.index')); ?>">
                    <span>Danh mục</span>
                    <small>Groups</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.orders.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.index')); ?>">
                    <span>Đơn hàng</span>
                    <small>Sales</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.users.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>">
                    <span>Người dùng</span>
                    <small>Accounts</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.posts.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.posts.index')); ?>">
                    <span>Bài viết</span>
                    <small>Content</small>
                </a>
                <a class="sidebar-link <?php echo e(str_starts_with($currentRoute ?? '', 'admin.contacts.') ? 'active' : ''); ?>" href="<?php echo e(route('admin.contacts.index')); ?>">
                    <span>Liên hệ</span>
                    <small>Inbox</small>
                </a>
                <a class="sidebar-link" href="<?php echo e(route('user.home')); ?>">
        ...
        <section class="content">
            <?php if(session('success')): ?>
                <div class="card" style="margin-bottom:18px; color:#86efac;"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
...
<?php /**PATH D:\lemin\laragon\www\Webbanweb\resources\views/layouts/admin.blade.php ENDPATH**/ ?>