    ...
    <section class="page-section card" style="padding:20px;">
        <div class="category-hero">
            <?php if($category->image_path): ?>
                <img class="category-hero-image" src="<?php echo e(\Illuminate\Support\Str::startsWith($category->image_path, ['http://', 'https://']) ? $category->image_path : '/'.$category->image_path); ?>" alt="<?php echo e($category->name); ?>">
            <?php else: ?>
                <div class="category-hero-image"></div>
            <?php endif; ?>

            <div class="category-hero-copy">
                <h1 class="section-title" style="margin-bottom:8px;">Danh mục: <?php echo e($category->name); ?></h1>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\lemin\laragon\www\Webbanweb\resources\views/user/category/index.blade.php ENDPATH**/ ?>