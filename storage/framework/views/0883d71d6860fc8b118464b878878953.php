...
<head>
    ...
    <title><?php echo e($title ?? 'Web Bán Source Code'); ?></title>
    <style>
        :root {
            --red: #ff6a3d;
            --red-deep: #ff2d55;
    ...
    <header class="site-header">
        <div class="container">
            <div class="header-main">
                <a href="<?php echo e(route('user.home')); ?>" class="logo-badge"><span>Code Store</span></a>

                <form class="search-wrap" action="<?php echo e(route('user.products')); ?>" method="GET">
                    <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" placeholder="Nhập từ khóa cần tìm...">
                    <button type="submit" aria-label="Tìm kiếm">⌕</button>
                </form>

                <div class="header-tools">
                    <a class="tool-link" href="<?php echo e(route('user.profile')); ?>">
                        <span class="tool-icon">✓</span>
                        <span>Theo dõi đơn hàng</span>
                    </a>
                    <a class="tool-link" href="<?php echo e(route('user.contact')); ?>">
                        <span class="tool-icon">☎</span>
                        <span>Hỗ trợ đặt hàng</span>
                    </a>
                    <div class="header-account">
                        <a class="cart-pill" href="<?php echo e(route('user.cart')); ?>" aria-label="Giỏ hàng">
                            <span>🛒</span>
                            <span class="cart-price"><?php echo e($cartCount); ?></span>
                        </a>
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(auth()->user()->role === 'admin'): ?>
                                <a class="admin-shortcut" href="<?php echo e(route('admin.dashboard')); ?>">Admin</a>
                            <?php endif; ?>
                            <span class="login-chip" style="background:rgba(255,255,255,0.12);">
                                So du: <?php echo e(number_format(auth()->user()->balance)); ?> đ
                            </span>
                            <div class="account-menu" data-account-menu>
                                <button type="button" class="login-chip account-chip" aria-haspopup="true" aria-expanded="false" data-account-toggle>
                                    <span class="account-name">Xin chào, <?php echo e(auth()->user()->name); ?></span>
                                    <span class="account-caret">▼</span>
                                </button>
                                <div class="account-dropdown" data-account-dropdown>
                                    <?php if(auth()->user()->role === 'admin'): ?>
                                        <a href="<?php echo e(route('admin.dashboard')); ?>">Vào trang quản trị</a>
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('user.profile')); ?>">Tài khoản của tôi</a>
                                    <form method="POST" action="<?php echo e(route('user.logout')); ?>" style="margin:0;">
                                        <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <a class="login-chip" href="<?php echo e(route('user.login')); ?>">Đăng nhập / Đăng ký</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="header-bottom">
                <nav class="main-nav">
                    <a href="<?php echo e(route('user.home')); ?>">☰ Danh mục sản phẩm</a>
                    <a href="<?php echo e(route('user.products')); ?>">Sản phẩm</a>
...
<?php /**PATH D:\lemin\laragon\www\Webbanweb\resources\views/layouts/user.blade.php ENDPATH**/ ?>