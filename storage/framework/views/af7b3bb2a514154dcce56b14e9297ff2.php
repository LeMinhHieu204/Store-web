            ...
            <aside class="category-panel">
                ...
                <div class="category-list">
                    <?php $__currentLoopData = $categories->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('user.category', $category->slug)); ?>">
                            <?php if($category->image_path): ?>
                                <img class="category-thumb" src="<?php echo e(\Illuminate\Support\Str::startsWith($category->image_path, ['http://', 'https://']) ? $category->image_path : '/'.$category->image_path); ?>" alt="<?php echo e($category->name); ?>">
                            <?php else: ?>
            ...
            <div>
                <?php $__currentLoopData = $categorySections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section class="section-block">
                        <h2 class="section-title"><?php echo e($section['category']->name); ?> nổi bật</h2>
                        <div class="product-row">
                            <?php $__currentLoopData = $section['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="product-card-mini">
                                    ...
                                    <a href="<?php echo e(route('user.product.show', $product->slug)); ?>">
                                        <img class="main" src="<?php echo e(\Illuminate\Support\Str::startsWith($product->thumbnail, ['http://', 'https://']) ? $product->thumbnail : '/'.$product->thumbnail); ?>" alt="<?php echo e($product->title); ?>">
                                    </a>
                                    <h3><a href="<?php echo e(route('user.product.show', $product->slug)); ?>"><?php echo e($product->title); ?></a></h3>
                                    <div class="price-row">
                                        <?php if($product->has_discount): ?>
                                            <span class="old-price"><?php echo e(number_format($product->display_original_price)); ?> đ</span>
                                        <?php endif; ?>
                                        <span class="new-price"><?php echo e(number_format($product->display_sale_price)); ?> đ</span>
                                    </div>
                                </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <section class="side-card">
                    ...
                    <div class="featured-list">
                        <?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="featured-item" href="<?php echo e(route('user.product.show', $product->slug)); ?>">
                                <img src="<?php echo e(\Illuminate\Support\Str::startsWith($product->thumbnail, ['http://', 'https://']) ? $product->thumbnail : '/'.$product->thumbnail); ?>" alt="<?php echo e($product->title); ?>">
                                <div>
                                    <h4><?php echo e($product->title); ?></h4>
                                    <?php if($product->has_discount): ?>
                                        <div class="old-price"><?php echo e(number_format($product->display_original_price)); ?> đ</div>
                                    <?php endif; ?>
                                    <div class="new-price"><?php echo e(number_format($product->display_sale_price)); ?> đ</div>
                                </div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <section class="side-card">
                    ...
                    <div class="news-list">
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('user.contact')); ?>"><?php echo e($post->title); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </section>
            </aside>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\lemin\laragon\www\Webbanweb\resources\views/user/home/index.blade.php ENDPATH**/ ?>