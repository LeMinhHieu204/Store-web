                ...
                <div class="metric-stack">
                    ...
                    <div class="metric-row">
                        <div>
                            ...
                            <strong>{{ number_format($averageOrderValue) }} đ</strong>
                        </div>
            ...
            <div class="card stat-card">
                <div class="stat-top">
                    <div>
                        ...
                        <div class="stat-value">{{ $latestOrders->count() }}</div>
                    </div>
            ...
            <div class="card stat-card">
                <div class="stat-top">
                    <div>
                        ...
                        <div class="stat-value">{{ $recentUsers->count() }}</div>
                    </div>
        ...
        <div class="dashboard-grid">
            <div class="table-wrap">
                <div class="table-head">
                    ...
                    <span class="table-chip">{{ $latestOrders->count() }} đơn gần nhất</span>
                </div>
                ...
                <div class="list-stack">
                    @forelse($latestOrders as $order)
                        <div class="activity-item">
                            <div>
                                <span class="title">Đơn #{{ $order->id }}</span>
                                <div class="activity-meta">{{ $order->user->name }}</div>
                            </div>
                            <div style="text-align:right;">
                                <strong>{{ number_format($order->total_price) }} đ</strong>
                                <div class="activity-meta">{{ ucfirst($order->status) }}</div>
                            </div>
                        </div>
                    @empty
                        <div class="activity-item">
            ...
            <div class="list-stack">
                <div class="table-wrap">
                    <div class="table-head">
                        ...
                        <span class="table-chip">{{ $recentUsers->count() }} tài khoản</span>
                    </div>
                    ...
                    <div class="list-stack">
                        @forelse($recentUsers as $user)
                            <div class="activity-item">
                                ...
                                <div class="activity-meta">{{ strtoupper($user->role) }}</div>
                            </div>
                        @empty
                            <div class="activity-item">
                ...
                <div class="table-wrap">
                    ...
                    <div class="list-stack">
                        @forelse($topProducts as $item)
                            <div class="activity-item">
                                <div>
                                    <span class="title">{{ $item->product?->title ?? 'Sản phẩm đã xóa' }}</span>
                                    <div class="activity-meta">Product ID: {{ $item->product_id }}</div>
                                </div>
                                <strong>{{ $item->total_sales }} lượt</strong>
                            </div>
                        @empty
                            <div class="activity-item">
